							...
							React.createElement("ul", {className: "nav navbar-nav"}, 
                              React.createElement("li", {className: "dropdown"}, 
                                React.createElement("a", {id: "dropExample", href: "#", className: "dropdown-toggle", "data-toggle": "dropdown", "aria-haspopup": "true", role: "button", "aria-expanded": "false"}, 
                                    React.createElement("span", {className: "glyphicon glyphicon-wrench", "aria-hidden": "true"}), " Examples ", React.createElement("span", {className: "caret"})), 
								...
								React.createElement("li", {className: "dropdown"}, 
									React.createElement("a", {id: "dropExample", href: "#", className: "dropdown-toggle", "data-toggle": "dropdown", "aria-haspopup": "true", role: "button", "aria-expanded": "false"}, 
										React.createElement("span", {className: "glyphicon glyphicon-fire", "aria-hidden": "true"}), " Promises ", React.createElement("span", {className: "caret"})), 
									React.createElement("ul", {className: "dropdown-menu", role: "menu", "aria-labelledby": "dropExample"}, 
