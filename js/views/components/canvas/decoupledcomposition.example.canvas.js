define(function (require) {
                ...
                React.createElement("div", {className: "panel panel-default"}, 
                    React.createElement("div", {className: "panel-body"}, 
                        React.createElement("div", {className: "input-group"}, 
                            ...
                            React.createElement("input", {type: "search", placeholder: "Enter Search Text (e.g. 'customer 10')", 
    ...
    var CustomerList = React.createClass({displayName: "CustomerList",
        ...
        onItemClicked: function (index) {
            MessageHandler.showSuccess(JSON.stringify(this.state.customers[index]));
        },
        ...
        render: function () {
            ...
            var customerCards = this.state.customers.length === 0 ?
                ...
                this.state.customers.map(function (customer, index) {
                    return React.createElement(CustomerCard, {key: index, name: customer.name, email: customer.email, 
            ...
            return (
                React.createElement("div", {className: "panel panel-default"}, 
                    React.createElement("div", {className: "panel-heading"}, 
                        ...
                        React.createElement("small", {className: "pull-right"}, "Found: ", this.state.customers.length)
                    ), 
                    React.createElement("div", {className: "panel-body"}, 
                ...
                React.createElement("div", null, 
                    React.createElement("div", {className: "row"}, 
                        React.createElement("div", {className: "col-xs-12 col-sm-12"}, 
                            ...
                            React.createElement("p", null, "This example demonstrates the decoupled composition. Two independent components" + ' ' +
