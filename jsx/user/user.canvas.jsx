define(['react', 
		...
		'component/user/user.editor',
		'component/card.list',
		'component/user/user.card',
	...
	function (React, GenericService, $actionProvider, CardsControl, EditorFrame, UserEditor, CardList, UserCard, MoreButton, DetailsList, MixinFullSizeEditor, MixinActionProvider) {
       ...
       getInitialState: function () {
		...
		createUserCardClass : function(){
			return UserCard; // todo: make more consistent
		},         
						...
						<div className="panel panel-default">
							...
							<div className="panel-body">
								...
								<section className="section-container-cards">
									<CardList cardContentClass={this.createUserCardClass()} restService={new GenericService('/usuario')} cardItemClass='card-item'/>
								</section>
							</div>
