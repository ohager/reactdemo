                ...
                <div className="panel panel-default">
                    <div className="panel-body">
                        <div className="input-group">
                            ...
                            <input type="search" placeholder="Enter Search Text (e.g. 'customer 10')"
            ...
            return (
                <div className="panel panel-default">
                    <div className="panel-heading">
                        ...
                        <small className="pull-right">Found: {this.state.customers.length}</small>
                    </div>
                    <div className="panel-body">
                ...
                <div>
                    <div className="row">
                        <div className="col-xs-12 col-sm-12">
                            ...
                            <p>This example demonstrates the decoupled composition. Two independent components
